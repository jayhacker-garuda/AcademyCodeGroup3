                ...
                <div class=" p-8 bg-white shadow-sm sm:rounded-xl">
                    ...
                    <form action="#" method="POST" class="w-full">
                        ...
                        <div class="mb-5 relative">
                            <input type="text" id="category_name" class="peer pt-8 border border-gray-200 focus:outline-none rounded-md focus:border-gray-500 focus:shadow-sm w-full p-3 h-16 placeholder-transparent" autocomplete="off" />
                        ...
                        <div class="mb-5 relative">
                            <input type="text" id="category_desc" placeholder="Maximum 50 Characters" maxlength="50" class="peer pt-8 border border-gray-200 focus:outline-none rounded-md focus:border-gray-500 focus:shadow-sm w-full p-3 h-16 placeholder-gray-600" autocomplete="off" />
